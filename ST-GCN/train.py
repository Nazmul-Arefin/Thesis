...
data_dir = 'G:/Downloads/STGCN/dataset/NTU-RGB-D/xsub/'
...
if phase == 'train':
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        info = "Epoch [{}/{}], Training accuracy: {:.2f}%, Training loss: {:.4f}, Validation loss: {:.4f}, Validation accuracy: {:.2f}%".format(epoch+1, NUM_EPOCHS, train_acc*100, train_loss.item(), val_loss.item(), val_acc*100)
